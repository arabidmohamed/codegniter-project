    ...
    padding-top: 2em;">
        <tr>
          ...
          <td align="center" valign="buttom">
            <h3 class="text-center" style="color: #0795a4;font-size: 2em;">Reset Password Request </h3>
          </td>
          <td align="left">
	      ...
	      <tr>
		      <td align="" class="mobileOn">
				...
				<p class="en" style="direction: ltr; color: #7f7f7f; font-size: 18px;">
					<?=getSystemString(754)?> {username}<br><br>
					...
					<br><br>
					<div align="center">
					<a href="<?=base_url($controller.'/resetPasswordRequest/'.$reset_token)?>" target="_blank" style="text-decoration: none;color: white;background: #0795a4;
			      ...
			      <tr>
				         <div align="center" style="border-top: 1px solid lightgray; padding-top: 2em;direction: ltr;width: 800px;">
							...
							<a href="https://www.dnet.sa" target="_blank" style="text-decoration: none;">
								<p class="copyright" style="color: #7f7f7f;text-decoration: none;">@ 2019 - 2020 DNet</p>
							</a>
						</div>
			      </tr>
		       </table>
