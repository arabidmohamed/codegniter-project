<div class="panel white" style="height: auto;overflow: hidden; padding-bottom: 10px;margin-bottom: 20px;padding-bottom: 20px">
	<h4 class="page-title"><?=getSystemString(370)?></h4>
	<div class="col-xs-12 no-padding">
		<form action="" method="post" id="filter_subscriptions">
			<div class="col-xs-12 col-sm-4 col-md-3 float-right-left">
				<div class="form-group">
					<input type="text" id="filter_name" placeholder="اسم الباقة" class="form-control" />
				</div>
		    </div>
		  
		    <div class="col-xs-12 col-sm-4 col-md-3 float-right-left">
				<div class="form-group">
					<input type="text" id="filter_promocode" placeholder="الرمز الترويجي" class="form-control" />
				</div>
		    </div>
		  
		    <div class="col-xs-12 col-sm-4 col-md-3 float-right-left hide">
				<div class="form-group">
					<select class="form-control" id="filter_payverified">
