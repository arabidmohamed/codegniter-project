...
<div id="content-main">
    <div class="row">
        ...
        <div class="col-md-12">
            <h3>
            <?=getSystemString('transfer_domain_orders')?>
            </h3>
        </div>
        ...
        <div class="col-md-12">
            <?PHP 
                  ...
                  $this->load->view('domains/snippets/filter_transfer', $data); 
            ?>
        </div>
                ...
                <table class="table table-hover" id="domains_table">
                    <thead>
                        <tr>
                            ...
                            <th>
                            <?=getSystemString('account_email_holder')?>
                            </th>

                              <th>
                              <?=getSystemString('email_transferred_from')?>
                                
                            </th>

                            <th>
                            <?=getSystemString('order_status')?>
                            </th>
                         <!--    <th>
                                <?=getSystemString(355)?>
                            </th> -->
...
<script>
    $(function() {
        ...
        var dTable = $('#domains_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?=base_url($__controller.'/getTransferIn')?>",
                type: "POST",
                cache: false,
                data: function(d) {
