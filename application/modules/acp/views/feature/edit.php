...
<div id="content-main">
    ...
    <div class="row">
        ...
        */
        ...
        <div class="col-md-12">
            <h3>Modify Menu</h3>
            <form action="<?=base_url($__controller.'/edit_POST/'.$feature_id);?>" class="form-horizontal" method="post" data-parsley-validate>
                <div class="panel white" style="padding-bottom: 50px;">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 no-padding-left">
                            <select name="pid" class="form-control select2">
                                ...
                                <?php foreach ($rbac_menus as $rm):?>
                                    <option value="<?=$rm->Id?>" <?PHP if($feature->PID == $rm->Id){ echo 'selected'; } ?>><?=getSystemString($rm->Menu_String_Key)?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12 col-sm-4 col-md-2">
                            <label for="websiteLink"><?=getSystemString("website_link")?></label>
                        </div>
                        <div class="col-xs-12 col-sm-8 col-md-6 no-padding-left">
                            <input type="input"
                                   class="form-control"
                                   name="websiteLink"
                                   value="<?=$feature->Website_Link?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6">
                            <label class="checkbox">
                                <input type="checkbox"
                                       name="isHeader"
                                       varlue="1" style="font-size: 16px" <?PHP if($feature->Is_Header){ echo 'checked'; } ?>> <?=getSystemString(705)?>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6">
                            <label class="checkbox">
                                <input type="checkbox"
                                       name="isFooter"
                                       varlue="1" style="font-size: 16px" <?PHP if($feature->Is_Footer){ echo 'checked'; } ?>> <?=getSystemString(706)?>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12 text-right">
                        <input type="submit" class="btn btn-primary" value="<?=getSystemString("edit_feature")?>" name="submit"/>
                    </div>
                </div>
            </form>
