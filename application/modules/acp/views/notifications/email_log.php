...
<div id="content-main">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="<?=getSystemString(744)?><"><?=getSystemString(744)?></li>
        </ol>
    </nav>
    <h3><?=getSystemString(744)?></h3>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="panel white" style="height: auto;overflow: hidden; padding-bottom: 40px;margin-bottom: 20px">
                <table class="table table-hover display" id="email" width="100%">
                    <thead>
                    <tr>
                        <th width="20"><?=getSystemString(41)?></th>
                        <th width="120"><?=getSystemString(244)?></th>
...
<script>
    ...
    $(function(){
        var dTable = $('#email').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?=base_url('acp/datatable/getEmailLogs')?>",
                type: "POST"
            },
            language: {
