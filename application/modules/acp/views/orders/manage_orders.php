...
<script>
    $(function() {
        ...
        var dTable = $('#orders_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?=base_url($__controller.'/getOrdersList')?>",
                type: "POST",
                cache: false,
                data: function(d) {
            ...
            initComplete: function() {
                $("div.toolbar").html('<div class="dropdown">' +
                    ...
                    '  <li role="presentation"><a role="menuitem" tabindex="-1" href="<?=base_url("acp/export/orders_csv/")?>">Export to csv</a></li>' +
                    '  <li role="presentation"><a role="menuitem" tabindex="-1" href="<?=base_url("acp/export/orders_excel/")?>">Export to excel</a></li>' +
                    '</ul>' +
                    '</div>');
            }
        });
