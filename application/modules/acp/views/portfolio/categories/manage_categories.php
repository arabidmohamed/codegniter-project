        ...
        <nav aria-label="breadcrumb">
			...
			<div class="row">
				...
				<div class="col-md-12">
        			...
        			<form action="<?=base_url($__controller.'/updateCategory');?>" class="form-horizontal" method="post" enctype="multipart/form-data">
		          <div class="panel white" style="padding-bottom: 50px;">
			          ...
			          <div class="tab-content">
				           ...
				           <div class="tab-pane fade w-editor <?PHP if ($__lang == 'en') { echo 'in active'; } ?>" id="lang_en">
						         <div class="form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-6 no-padding-left">
										<input type="text" class="form-control" name="name_en" placeholder="<?=getSystemString(49)?>" value="<?=$category[0]->Category_en?>">
										<br>
				          ...
				          <div class="tab-pane fade <?PHP if ($__lang == 'ar') { echo 'in active'; } ?>" id="lang_ar">
					          <div class="form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-6 no-padding-left">
										<input type="text" class="form-control" name="name_ar" placeholder="<?=getSystemString(49)?>" value="<?=$category[0]->Category_ar?>" dir="rtl">
										<br>
...
<script>
	$(function(){
		...
		$(document).on('click',"#categories_table tr td .hurkanSwitch", function(){
			ChangeStatusFor($(this), 'portfolio_categories');
		});
		
		ChangeOrder('portfolio_categories');
	});
</script>
</body>
</html>