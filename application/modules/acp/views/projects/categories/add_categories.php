<style>
	...
	<div id="content-main">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="<?=$pageName[0]->$section?> <"><a href="<?=base_url('acp/projects/categories_list')?>"><?=getSystemString(317)?></a></li>
				          ...
				          <div class="tab-content">
				           ...
				           <div class="tab-pane fade w-editor <?PHP if ($__lang == 'en') { echo 'in active'; } ?>" id="lang_en">				         
						         <div class="form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-5 no-padding-left">
										<input type="text" class="form-control" name="name_en" required data-parsley-required-message="<?=getSystemString(213)?>" placeholder="<?=getSystemString(49)?>">
				           ...
				           <div class="tab-pane fade <?PHP if ($__lang == 'ar') { echo 'in active'; } ?>" id="lang_ar">
					           <div class="form-group">
									...
									<div class="col-xs-12 col-sm-8 col-md-5 no-padding-left">
										<input type="text" class="form-control" name="name_ar" required data-parsley-required-message="<?=getSystemString(213)?>" placeholder="<?=getSystemString(49)?>" dir="rtl">
									</div>
								</div>
				           </div>
