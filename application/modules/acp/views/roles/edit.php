...
<div id="content-main">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-md-12">
            <form action="<?=base_url($__controller.'/edit_POST');?>" class="form-horizontal" method="post">
                ...
                <div class="panel white" style="padding-bottom: 50px;">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 no-padding-left">
                            <input type="text" class="form-control" value="<?=$role->Name?>" name="role" placeholder="<?=getSystemString(749)?>" required>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        foreach($actions as $action):
                                            ...
                                            foreach($permissions as $p):
                                                if($p->Menu_ID == $page->Id && $p->Action_ID == $action->Action_ID){
                                                    $permitted = 'checked';
                                                }
                                            endforeach;
                                            ?>
                                            <td>
                                                <input type="checkbox" name="action[<?=$page->Id.'_'.$action->Action_ID?>]" value="<?=$page->Id.'_'.$action->Action_ID?>" <?=$permitted?> onclick="resetSelectAll(this)" data-type="<?=$action->Action_Key?>-data">
                                            </td>
                                        <?PHP
                                        endforeach;
                                        endif;
