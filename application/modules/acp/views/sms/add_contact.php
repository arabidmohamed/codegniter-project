...
<div id="content-main">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="<?=getSystemString(735)?>"><?=getSystemString(735)?></li>
        </ol>
    </nav>
    <div class="row">
        ...
        <div class="col-md-12">
            <h3><?=getSystemString(735)?></h3>
            <form action="<?=base_url($__controller.'/addContact_POST/'.$menu_id);?>" class="form-horizontal" method="post" data-parsley-validate>
                ...
                <div class="form-group">
                    <div class="col-xs-12 text-right">
                        <input type="submit" class="btn btn-primary" value="<?=getSystemString(735)?>" name="submit"/>
                    </div>
                </div>
