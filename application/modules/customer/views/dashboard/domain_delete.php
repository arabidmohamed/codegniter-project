                            ...
                            <div class="bs-stepper-content mt-5">
                                ...
                                <div id="delete-domain">
                                	...
                                	<div class="text-center text-muted">
                                		<h4 class="pb-3"><?= getSystemString('delete_domain_title') ?> : <?= $domain_info->Domain_Name.$domain_info->TLD ?></h4><!-- /.text-muted -->
                                		<p class="pb-4"><?= getSystemString('delete_domain_msg') ?></p>
                                		<div class="col-md-6 mx-auto">
                                			...
                                			<a href="#!" class="btn btn-outline-primary dltBtn"><?= getSystemString('confirm') ?></a><!-- /.btn btn-outline-primary -->
             ...
             var data = {
                        ...
                        success: function(data) {
                           ...
                           if(data.status === true){
                               ...
                               window.location.href = base_url('domain_details/')+'<?= encryptIt($domain_info->Domain_ID) ?>'
                           }else{
