...
<div class="payment_panel">
                ...
                <form action="<?=base_url("renew_payment_success")?>" class="paymentWidgets" data-brands="MADA"></form>
                 <?php if(ENVIRONMENT == 'development') { ?>    <script src="https://test.oppwa.com/v1/paymentWidgets.js?checkoutId=<?=$checkout_id?>"></script> <?php } else { ?> <?php if(ENVIRONMENT == 'development') { ?>    <script src="https://test.oppwa.com/v1/paymentWidgets.js?checkoutId=<?=$checkout_id?>"></script> <?php } else { ?> <script src="https://oppwa.com/v1/paymentWidgets.js?checkoutId=<?=$checkout_id?>"></script> <?php } ?></script> <?php } ?>
</div>
                      ...
                      <div class="details-table">
                        <table class="table table-responsive table-course">
                          ...
                          <tr>
                            ...
                            <?php 
                                 $renew_price = $period * $renew_price;
  ...
  $(function()
  {
        ...
        var data = {
           ...
           '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
                     ...
                     $.ajax({
                            url: "<?php echo base_url('payment_methods_renew');?>",
                            type: "POST",
                            data: data,
                            dataType : 'html',
                             async:false,
