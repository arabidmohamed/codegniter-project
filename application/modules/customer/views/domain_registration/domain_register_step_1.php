...
<style>
  ...
  /* Note: added by A */
    html[dir="rtl"] .stepOneFrm .details .input-group-text{
        direction: rtl;
    }
    html[dir="ltr"] .stepOneFrm .details .input-group-text{
        direction: ltr;
    }
</style>
                    ...
                    <div id="newDomain" class="tab-pane fade in active show">
                        <div class="bs-stepper">
                            ...
                            <div class="bs-stepper-content p-lg-5 p-3 mt-5">
                               ...
                               <?php  } ?>
                                    <form action="<?= base_url('domain_docs') ?>" class="stepOneFrm" method="post" data-parsley-validate>
									   ...
									   <div class="row no-gutters align-items-center details">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group domain-name-box">
                                                    ...
                                                    <input dir="ltr" type="text" value="<?= $domain_name ?>" class="form-control domain-input" placeholder="" aria-describedby="button-addon1" required data-parsley-required-message="<?=getSystemString('required')?>"   autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-12 search_res"></div>
                                        ...
                                        <div class="row no-gutters align-items-center details mt-4">
                                            ...
                                            <div class="col-md-9 offset-md-2 hide incomplete_app">
                                                <div class="alert alert-warning" role="alert">
                                                <?= getSystemString('incomplete_app_msg') ?>
                                                <?= getSystemString('more_d') ?>
                                                <a id="incomplete_url" href="" target="_blanl"><?= getSystemString('click_here') ?></a>
                                                </div>
                                            </div>


											<div class="col-lg-2 col-md-3">
                                                <label class="title-label mb-md-0 mb-4 title-label mb-md-0 mb-4"><?= getSystemString('domain_duration'); ?> </label>
                                            </div>

                                            <div class="col-md-2 mb-3">
                                                <select class="custom-select px-4 years" name="period">
                                                  <?php for ($i=1 ; $i<=10 ;$i++) { ?>
                                                     <option <?= ($period == $i)?'selected':'' ?> value="<?= $i ?>"><?= $i ?></option>
                                                  <?php } ?>
                                                </select>
                                                <label for="years" class="text-grey ml-3"><?= getSystemString('years') ?></label>
                                            </div>
...
<p class="total_price" style=" color: #B5B5B5;"><?= $total_price ?></p> <p style="color: #B5B5B5;"> <?= '  '.getSystemString(480).' '.getSystemString('total_tax_incl') ?></p>
                                        ...
                                        <div class="row no-gutters align-items-center  details">
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input value="<?= $domain->Registrar->Full_Name ?>" type="text" name="entity_name" class="activity_type_ipnut" placeholder="<?= getSystemString('entity_name') ?>"
                                            ...
                                            <div class="col-md-9 mb-3">
                                                  ...
                                                  pattern="^([0-9a-zA-Zء-ي ,-_]*?)\s+([0-9a-zA-Zء-ي]*)$" data-parsley-trigger="change"
                                   ...
                                   >
											...
											<div class="hide">
												...
												<div class="col-md-9 mb-3">
													<input value="<?= $domain->Registrar->User_Address2 ?>" type="text" name="second_address_org" placeholder="<?= getSystemString('contact_address2_placeholder') ?>" data-parsley-debounce="500" >
												</div>
											</div>
                                      ...
                                      data-parsley-type-message="<?=getSystemString(213)?>"
                                       ...
                                       data-parsley-debounce="500">
                                            ...
                                            <div class="col-md-9 mb-3">
                                                  ...
                                                  pattern="^([0-9a-zA-Zء-ي ,-_]*?)\s+([0-9a-zA-Zء-ي]*)$" data-parsley-trigger="change"
                                                data-parsley-pattern-message="<?=getSystemString('address_pattern')?>"
                                                 type="text" name="first_address[]" placeholder="<?= getSystemString('eg_altaawun') ?>"  required data-parsley-required-message="<?=getSystemString('required')?>">
                    ...
                    <option <?= ($row->Country_ID ==  $domain->Admin->User_Country_ID)?'selected':($row->Country_ID == 194)?'selected':'' ?>  value="<?=$row->Country_ID?>"><?=$row->$cat_nn?></option>
                                    ...
                                    ?>
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input  value="<?= $domain->Admin->User_City ?>" type="text" name="city[]" placeholder="<?= getSystemString('contact_city_placeholder') ?>"  required data-parsley-required-message="<?=getSystemString('required')?>"
                                                 data-parsley-debounce="500">
                                            </div>
                        ...
                        <input value="" type="tel" class="form-control  sa_default phone_flag " name="mobile[]"  id="mobile" 
                                     dir="ltr" 
                    ...
                    <input class="form-control mobile_key" 
                         ...
                         value="966"> 
                          ...
                          <div  class="hide text-danger"><?=getSystemString('mobile_error')?></div>
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input  value="<?= $domain->Admin->User_Email ?>" type="email" name="email[]" id="email1" placeholder="<?= getSystemString('contact_email_placeholder') ?>"
                                      ...
                                      data-parsley-type-message="<?=getSystemString(183)?>"
                                       ...
                                       <div class="hide">
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input value="<?= $domain->Admin->Employer_Name ?>" type="text" name="employer_name[]" placeholder="<?= getSystemString('contact_entity_placeholder') ?>"
                                     ...
                                     >
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input  value="<?= $domain->Admin->User_Job_Title ?>" type="text" name="job_title[]" placeholder="<?= getSystemString('contact_job_title_placeholder') ?>"
                                       data-parsley-required-message="<?=getSystemString('required')?>"
                                       data-parsley-debounce="500"
                                      >
                                            </div>
                                ...
                                <div class="col-12 mt-4"></div><!-- /.mt-3 -->
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input value="<?= $domain->Admin->User_Address2 ?>" type="text" name="second_address[]" placeholder="<?= getSystemString('contact_address2_placeholder') ?>"  data-parsley-debounce="500">
                                            </div>
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input  value="<?= $domain->Admin->User_Region ?>" type="text" name="region[]" placeholder="<?= getSystemString('contact_region_placeholder') ?>"
                                                 data-parsley-debounce="500">
                                            </div>
                                    ...
                                    <div class="col-12 mt-4"></div><!-- /.mt-3 -->
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input  value="<?= $domain->Admin->User_Post_Code ?>" type="text" name="post_code[]" placeholder="<?= getSystemString('contact_post_code_placeholder') ?>"  data-parsley-required-message="<?=getSystemString('required')?>"
                                                data-parsley-trigger="keyup" data-parsley-validation-threshold="1" data-parsley-debounce="500" data-parsley-type="digits"
                                                 data-parsley-debounce="500"
                                                >
                                            </div>
                ...
                <div class="input-group" dir="ltr">
                    ...
                    <input  value="<?= $domain->Admin->User_Phone ?>" type="tel" class="tele_number" pattern="[5]{1}[0-9]{8}" name="phone[]"  >
                ...
                <div class="input-group">
                              <input  value="<?= $domain->Admin->User_Fax ?>" type="tel" class="tele_number" name="fax[]"   >
                    ...
                    <div class="input-group-prepend">
                      <label class="input-group-text" id="basic-addon1">966+</label>
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input  value="<?= $domain->Admin->User_Email ?>" type="text" name="" placeholder="<?= getSystemString('verify_email') ?>"
                                                  pattern="/^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/"
                                       data-parsley-required-message="<?=getSystemString('required')?>"
                                      data-parsley-trigger="keyup"
                                      ...
                                      data-parsley-type-message="<?=getSystemString(183)?>"
                                       ...
                                       data-parsley-debounce="500">
                                        ...
                                        <div class="row no-gutters  details">
                                            <div class="col-lg-2 col-md-3 mb-3">
                                        <label class="title-label mb-md-0 mb-4 color-primary-2"><?= getSystemString('technical_responsible') ?></label>
                                            </div>
                                        ...
                                        <div style="display: <?= ($domain->Admin_ID != $domain->Technical_ID)?'block':'none'; ?>" id="anotherPersonDataForm">
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input value="<?= $domain->Technical->Full_Name ?>" type="text" name="full_name[]" placeholder="<?= getSystemString(81) ?>"
                                                pattern="^[a-zA-Zء-ي]+[(?<=\d\s]([a-zA-Zء-ي]+\s)*[a-zA-Zء-ي]+$"
                                      required data-parsley-required-message="<?=getSystemString('required')?>"
                                      data-parsley-trigger="change"
                                       data-parsley-pattern-message="<?=getSystemString('contact_full_name_pattern')?>"
                    ...
                    <option <?= ($row->Country_ID ==  $domain->Technical->User_Country_ID)?'selected':($row->Country_ID == 194)?'selected':'' ?>  value="<?=$row->Country_ID?>"><?=$row->$cat_nn?></option>
                                    ...
                                    ?>
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input value="<?= $domain->Technical->User_City ?>" type="text" name="city[]" placeholder="<?= getSystemString('contact_city_placeholder') ?>"   data-parsley-trigger="change" data-parsley-required-message="<?=getSystemString('required')?>">
                                            </div>
                ...
                <div class="col-md-9 mb-3 editMobileFrm" >
                        ...
                        <input value="" type="tel" class="form-control phone_flag" name="mobile[]"  id="mobile" 
                                     dir="ltr" 
                         ...
                         value="966"> 
                          ...
                          <div  class="hide text-danger"><?=getSystemString('mobile_error')?></div>
                                     ...
                                     >
                                        ...
                                        <div class="row no-gutters  details">
                                            <div class="col-lg-2 col-md-3 mb-3">
                                                <label class="title-label mb-md-0 mb-4 color-primary-2"><?= getSystemString('financial_officer') ?></label>
                                            </div>
                                        ...
                                        <div style="display: <?= ($domain->Admin_ID != $domain->Financial_ID)?'block':'none'; ?>" id="anotherEcoPersonDataForm">
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input value="<?= $domain->Financial->Full_Name ?>" type="text" name="full_name[]" 
                                                placeholder="<?= getSystemString(81) ?>"
                                                 pattern="^[a-zA-Zء-ي]+[(?<=\d\s]([a-zA-Zء-ي]+\s)*[a-zA-Zء-ي]+$"
                                      required data-parsley-required-message="<?=getSystemString('required')?>"
                                      data-parsley-trigger="change"
                    ...
                    <input class="form-control mobile_key" 
                         ...
                         value="966"> 
                          ...
                          <div  class="hide text-danger"><?=getSystemString('mobile_error')?></div>
                                            ...
                                            <div class="col-md-9 mb-3">
                                                <input value="<?= $domain->Financial->User_Email ?>" type="email" name="email[]" id="email3" placeholder="<?= getSystemString('contact_email_placeholder') ?>"
                                                 pattern="/^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/"
                                      required data-parsley-required-message="<?=getSystemString('required')?>"
                                      data-parsley-trigger="keyup"
                                      data-parsley-pattern-message="<?=getSystemString(183)?>"
        ...
        $.ajax({
            ...
            success: function(data) {
               ...
               if(data.incomp == 1){
                                ...
                                $('#incomplete_url').attr('href',data.url);
                                ...
                                $('.incomplete_app').removeClass('hide');
               }else{
