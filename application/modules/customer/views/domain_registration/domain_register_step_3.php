  ...
  <header class="header header-sub">
    <div class="intro">
      <div class="container pb-5 ">
        ...
        ID : #<?= $this->session->userdata($this->site_session->random_id())  ?>
 </p>
      </div>
    </div>
  </header>
                    ...
                    <div id="newDomain">
                        <div class="bs-stepper">
                            ...
                            <div class="bs-stepper-content p-lg-5 p-3 mt-5">
                                ...
                                <div id="review">
                                    <form action="<?= base_url('send_app_admin') ?>" method="post"  data-parsley-validate>
  ...
  <?php   $server_ips = json_decode($domain->Server_ips);?>
                                    ...
                                    <div id="box_server_2">
                                            ...
                                            <div id="box_server_<?= $i+$key ?>">
                                                <div class="row  details" style="margin-right: -30px;">
                                                    <div class="col-md-3 mb-3">
                                                        <label class="title-label mb-md-0 mb-4 "><?= getSystemString('secondary_server') ?></label>
                                                    </div>
                                                    <div class="col-md-9 mb-3">
