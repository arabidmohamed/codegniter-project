                    ...
                    <div id="newDomain">
                        <div class="stepper">
                            <h3 class="color-primary py-4 pb-5 mb-5 14em">
                                <?= getSystemString('financial_detail_to_register_domain') ?>
                            </h3>
                            <div class="row">
                <div class="col-lg-8">
            ...
            <?php if($can_add_transaction){ ?>           
              <input type="radio" id="payment-5"  name="payment-method" value="WALLET" class="input-hidden" autocomplete="off">
                          <label for="payment-5" class="payment-way flex-column">
                            ...
                            <span class="d-block"><?= getSystemString('WALLET') ?> </span>
                          </label>
...
<div class="payment_panel">
                ...
                <form action="<?=base_url("payment_success")?>" class="paymentWidgets" data-brands="MADA"></form>
                ...
                <div class="col-lg-4">
                  <div class="card mb-4">
                    <div class="card-body p-4">
                      <div class="">
                        <h5 class="title mb-4"><b> <?= getSystemString('financial_detail_to_register_domain') ?></b></h5>
                      </div>
                      <div class="details-table">
                        <table class="table table-responsive table-course">
                          ...
                          <tr>
                            ...
                            <?php 
                                 $registration_price = $period * $registration_price;
                                 $registration_price = number_format((float) $registration_price, 2, '.', ''); 
                            ?>
                            <tr>
                            <td class="border-top-0" scope="row"><?= getSystemString('domain_price') ?></td>
                            <td class="border-top-0 text-right"><?= $registration_price.' '.getSystemString(480) ?></td>
                            </tr>
  ...
  $(function()
  {
        ...
        var data = {
           ...
           '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
                     ...
                     $.ajax({
                            url: "<?php echo base_url('payment_methods');?>",
                            type: "POST",
                            data: data,
                            dataType : 'html',
                             async:false,
