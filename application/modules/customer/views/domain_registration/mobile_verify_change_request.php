  ...
  <div class="container dashboard">
    <div class="form-container p-lg-5 p-4">
            <div class=" ">
              ...
              <form action="<?=base_url('mobile_verify_change_request')?>" method="post" id="form" data-parsley-validate autocomplete="off">

               <input type="hidden" name="verify_page_token" value="<?=$token?>">
                <input type="hidden" name="do" value="<?= encryptIt($do) ?>">
...
$(function(){
  ...
  $('.sendData').on('click',function(e){
    ...
    $.post('<?=base_url('sendVerificationCodeRequest')?>', _data, function(result){
