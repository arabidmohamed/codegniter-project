                ...
                <div class="tab-content mt-5">
                    <div id="newDomain">
                        <div class="stepper">
                            ...
                            <div class="domain  row justify-content-center align-items-center" style="margin-bottom: 10px; ">
                                <div class="domain-name col-9">
                                     <?= $domain_details->Domain_Name.$domain_details->TLD ?>
                                </div><!-- /.col-6 -->
                                <div class="col-3">
                                <!--     <span class="domain-price"><?= $renew_price.' '.getSystemString(480) ?></span> -->
                                </div><!-- /.col-3 -->
                            </div><!-- /.row -->
                    ...
                    <div class="form-group row">
                      <div class="col-md-12">
                        <div class="payment-way-box ">
                          <input type="radio" id="payment-1" class="input-hidden payment_type" name="payment-method" value="MADA" checked required="" autocomplete="off">
...
<div class="payment_panel">
                ...
                <form action="<?=base_url("transfer_payment_success")?>" class="paymentWidgets" data-brands="MADA"></form>
                ...
                <div class="col-lg-4"> 
                  <div class="card mb-4">
                    <div class="card-body p-4">  
                      <div class="">
                        <h5 class="title mb-4"><b> التفاصيل المالية</b></h5>
                      </div>
                      <div class="details-table">
                        <table class="table table-responsive table-course"> 
                          ...
                          <tr>
                            ...
                            <td class="border-top-0 text-right"><?= $price.' '.getSystemString(480) ?></td>
                            </tr> 

                            <?PHP if(!empty($discount_value_before_vat)){ ?>
                            <tr>
                            <td class="border-top-0" scope="row"><?= getSystemString('Discount Value') ?>  (<?= $discount_percentage ?>٪)</td>
                            <td class="border-top-0 text-right"><?= $discount_value_before_vat.' '.getSystemString(480) ?></td>
                            </tr>
                          <?php } ?>


                            <?php 
                                 $total_vat = $period * $total_vat;
...
<script type="text/javascript">
  ...
  $(function()
  {
        ...
        '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
                     ...
                     $.ajax({
                            url: "<?php echo base_url('repay_order_change_cart');?>",
                            type: "POST",
                            data: data,
                            dataType : 'html',
                             async:false,
