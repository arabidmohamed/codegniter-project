			...
			<tr>
				<td style="background: #fff; padding: 2rem; border-bottom: 6px solid #eaeaea;">
					...
					<table cellpadding="10" style="padding: 1rem 0;">
						...
						<p>لقد قمت بإنشاء تذكرة جديدة حسب التفاصيل أدناه وسيتم الرد على تذكرتك من قبل فريق العمل.</p>
						<br>
						<p>تفاصيل التذكرة:</p>
						<ul>
			...
			<tr>
				<td style="background: #fff; padding: 2rem; border-bottom: 6px solid #eaeaea;">
					...
					<table cellpadding="10" style="padding: 1rem 0;">
						...
						<p>
							You just created a new ticket, our team will contact you shortly.
						</p>
						<br>
						<p>Ticket details:</p>
						<ul>
