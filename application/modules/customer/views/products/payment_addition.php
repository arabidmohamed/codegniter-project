...
<script type="text/javascript">
    $(".payment-way-box input[type='radio']").click(function () {
        if ($(this).val() !== '') {
            ...
            $.post("<?= base_url('products/checkout_addition/' . encryptIt($rId)) ?>",
                    {
