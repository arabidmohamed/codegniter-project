  ...
  <!-- End Header -->
	...
	<div class="form-container col-md-9 mx-auto pb-5">
		<div class="container">
					...
					<form action="<?=base_url('auth/two_factor_authentication')?>" method="post" id="form" data-parsley-validate autocomplete="off">

				<input type="hidden" name="verify_page_token" value="<?=$customer->Verify_Page_Token?>">
            ...
            <?=getSystemString('error_sms')?>
			   	...
			   	<div class="v-phone col-md-6 mx-auto">
			   		<h6 class="mb-4"><?php 
			   							...
			   							echo getSystemString('email_verify_code_msg');
