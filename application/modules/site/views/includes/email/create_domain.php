									...
									<tr>
										<td style=" border-bottom: 1px solid #E2E2E2">
											<table style="width: 100%; padding: 2rem ; font-size : 16px;">
												<tr>
													<td style="text-align: right;"><?=getSystemString('invoice_number')?> </td>
												...
												<tr>
													<td style="text-align: right;"><?=getSystemString('reason')?></td>
											...
											<div style="background: #FBFBFB;border-radius: 10px; padding: 2rem">
												...
												<table style="width: 100%; border-spacing: 0; margin-bottom: 2rem;">
													<tr>
														...
														<th style="background: #18C6EC; padding: 1rem; border-radius: 10px 0 0 10px;"><?=getSystemString('total')?></th>
													</tr>
													<tr>
														<td style="padding: .5rem 1rem;"><?= getSystemString('register_new_domain') ?></td>
														<th style="padding: .5rem 1rem;"><?= $period.' '.getSystemString('years') ?></th>
														<th style="padding: .5rem 1rem;"><?= $registration_price.' '.getSystemString(480) ?> </th>
													</tr>
												...
												<table style="width: 50%; float: left; border-spacing: 0; margin-bottom: 2rem; border-top: 1px solid #E2E2E2;padding-top: 1rem">
													<tr>
														...
														<th style="padding: .5rem 1rem;"><?= $registration_price_sub.' '.getSystemString(480) ?> </th>
													</tr>
													<tr>
