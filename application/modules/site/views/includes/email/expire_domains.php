	 ...
	 <?=   $this->load->view('site/includes/email/header',$data); ?>
									...
									<tr>
										<td style="text-align: center;">
											...
											<h1 style="color:#0F7EA7; font-size: 26px; font-weight: bold;"><?= getSystemString('expire_reminder') ?></h1>
										</td> 
									</tr> 
										...
										<td style=" border-bottom: 1px solid #E2E2E2">
											<table style="width: 100%; padding: 2rem ; font-size : 16px;">
												...
												<tr>
													<td style="text-align: right;"><?=getSystemString('351')?></td>
									...
									<tr>
										<td style="padding: 2rem 0">
											<div style="background: #FBFBFB;border-radius: 10px; padding: 2rem">
												<p style="font-size: 16px; color: #354052"><?=getSystemString('view_details')?></p>
												<h2 style="font-size: 20px; color: #354052"><?= $msg ?></h2>
											</div>
										</td> 
									</tr> 
									<!-- action -->
									<tr>
										<td style="padding: 3rem 0; text-align: center;">
											<a href="<?= base_url('my_domains'); ?>" style=" width: 300px;height: 56px;line-height: 56px;background: #18C6EC;color: #fff; display: inline-block; border-radius: 43px; text-align: center; text-decoration:none">
