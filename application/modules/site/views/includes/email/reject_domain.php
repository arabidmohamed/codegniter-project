	 ...
	 <?=   $this->load->view('site/includes/email/header',$data); ?>
									...
									<tr>
										<td style="padding: 2rem 0">
											<div style="background: #FBFBFB;border-radius: 10px; padding: 2rem">
												<p style="font-size: 16px; color: #354052"><?=getSystemString('rejection_reseaon')?> :</p>
												<h2 style="font-size: 20px; color: #354052"><?=  $reject_reasons ?></h2>
											</div>
										</td> 
									</tr> 
									<!-- action -->
									<tr>
										<td style="padding: 3rem 0; text-align: center;">
											<a href="<?= base_url('my_orders') ?>" style=" width: 300px;height: 56px;line-height: 56px;background: #18C6EC;color: #fff; display: inline-block; border-radius: 43px; text-align: center; text-decoration:none">
