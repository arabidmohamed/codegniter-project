			...
			<tr>
				<td style="background: #fff; padding: 2rem; border-bottom: 6px solid #eaeaea;">
					...
					<table cellpadding="10" style="padding: 1rem 0;">
						<p>مرحبا <?=$name?>,</p><br>
						<p>نود إبلاغك بأنه تم إغلاق التذكرة كما بإمكانك إعادة فتح التذكرة بالضغط على الرابط أدناه</p>
						<br>
						<p>تفاصيل التذكرة:</p>
						<ul>
					...
					<table cellpadding="10" style="padding: 1rem 0;">
						<p>مرحبا <?=$name?>, </p><br>
						<p>نود إبلاغك بأن طلبك معلق وبانتظار معلومات إضافية. نأمل الضغط على هذا الرابط لتزويدنا بالمعلومات المطلوبة.</p><br>
						<p>تفاصيل التذكرة:</p>
						<ul>
							<li>رقم التذكرة: #<?=$ticket_id?></li>
							<li>تاريخ إنشاء التذكرة: <?=$ticket_created_at?></li>
					    ...
					    <tr>
							<td> 
								<a href="<?=base_url('cu/support/ticket_details/'.encryptIt($ticket_id))?>" 
									target="_blank"
									style="background: #00759b; color: white; padding: 10px 2em; border-radius: 3px; text-decoration: none;">
									عرض التذكرة
								</a>
							</td>
						</tr>
			...
			<tr>
				<td style="background: #fff; padding: 2rem; border-bottom: 6px solid #eaeaea;">
					...
					<table cellpadding="10" style="padding: 1rem 0;">
						<p>Dear <?=$name?>,</p><br>
						<p>
							We would like to inform you that your ticket has been closed, you can reopen the ticket by clicking on the button below.
						</p>
						<br>
						<p>Ticket details:</p>
						<ul>
					...
					<table cellpadding="10" style="padding: 1rem 0;">
						<p>Dear <?=$name?>,</p><br>
						<p>
						    This is a kind reminder that your ticket is in need of further information,
							please click on the below button to submit the needed information.
						</p>
						<br>
						<p>Ticket details:</p>
						<ul>
