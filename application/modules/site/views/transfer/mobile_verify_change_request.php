  ...
  <!-- End Header -->
    ...
    <div class="form-container p-lg-5 p-4">
            <div class=" ">
              ...
              <form action="<?=base_url('mobile_verify_change_transfer_request')?>" method="post" id="form" data-parsley-validate autocomplete="off">
        ...
        ?>
          ...
          ?>
            ...
            <div class="row my-4 align-items-center">
              ...
              <div class="col-6"></div><!-- /.col-6 -->
              <div class="col-6">
                     <button type="submit"  name="submit"  class="v-btn mt-4 btn-block btn btn-primary-inverse"> <?= getSystemString('confirm') ?>  </button>
...
$(function(){
    ...
    $.post('<?=base_url('sendVerificationCodeTransferRequest')?>', _data, function(result){
