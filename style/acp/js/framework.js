...
$(function() {
	...
	if (isRTL) {
		...
		if (!$("link[href='"+__acp_css_path+"/bootstrap-rtl.min.css']").length)
			$('head').append('<link rel="stylesheet" href="'+__acp_css_path+'/bootstrap-rtl.min.css" type="text/css" />');
		if (!$("link[href='"+__acp_css_path+"/framework-rtl.css']").length)
			$('head').append('<link rel="stylesheet" href="'+__acp_css_path+'/framework-rtl.css" type="text/css" />');
	}
    ...
    if ($(window).width() <= 700) {
		...
		try {
		    ...
		    $(".sidebar .slimScrollDiv").css("height", "calc(100% - 170px)");
